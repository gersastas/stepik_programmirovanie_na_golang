...
Поэтому предварительно вам нужно убрать из них мусор и конвертировать в числа. Под мусором имеются ввиду лишние символы и спец знаки. Разрешается использовать только определенные пакеты: [fmt](https://golang.org/pkg/fmt/), [strconv](https://golang.org/pkg/strconv/), [unicode](https://golang.org/pkg/unicode/), [strings](https://golang.org/pkg/strings/), [bytes](https://golang.org/pkg/bytes/). Они уже импортированы, **вам ничего импортировать не нужно!**
