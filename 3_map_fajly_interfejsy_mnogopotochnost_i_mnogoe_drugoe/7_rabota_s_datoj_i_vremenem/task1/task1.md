...
Для более эффективной работы рекомендуется ознакомиться с документацией о [содержащихся в модуле time](https://pkg.go.dev/time?tab=doc#pkg-constants) константах.
